...
public class EnterMenstrualActivity extends AppCompatActivity implements DataUIAdapter2.ListItemClickListener {

    //Declare a TextView variable
    private final int NUM_LIST_ITEMS = 4;

    // References to RecyclerView and Adapter to reset the list to its
    // "pretty" state when the reset menu item is clicked.
    //private GreenAdapter mAdapter;
    private DataUIAdapter2 mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /*
         ...
         */
        mAdapter = new DataUIAdapter2(NUM_LIST_ITEMS, this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        String textToShow;
        Context context = EnterMenstrualActivity.this;
    ...
    public void onListItemClicked(int clickedItemIndex) {
         ...
         */
        Context context = EnterMenstrualActivity.this;
        Class destinationActivity = EnterMenstrualActivity.class;
